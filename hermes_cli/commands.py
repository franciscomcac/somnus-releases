...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of Somnus config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal Somnus works on across turns until achieved", "Session",
    ...
    CommandDef("wake", "Toggle the wake word listener", "Configuration",
               ...
               desktop="hidden"),
    CommandDef("busy", "Control how messages behave while Somnus is working", "Configuration",
    ...
    CommandDef("subscription", "View your Nous plan and change it in the browser", "Info",
               cli_only=True, aliases=("upgrade",), desktop="hidden"),
    CommandDef("login", "Sign in with a Nous account (keeps your connectors)", "Info",
               busy_policy="dispatch", desktop="settings"),
    # Somnus: Nous Portal billing does not apply to Somnus customers — kept runnable, out of the desktop popover.
    ...
    CommandDef("update", "Update Somnus to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Somnus version", "Info", aliases=("v",),

// Launching the Somnus TUI in the user's OWN terminal emulator.
//
...
// to work anywhere:
//
//  1. WHAT to run. The desktop's Somnus runtime is often a venv Python invoked
 ...
 * headless child) is the wrong answer for an interactive terminal. The Somnus

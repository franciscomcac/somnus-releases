...
/**
 * Return the Python snippet used to verify Somnus can import far enough to
...
/**
 * Return true iff the Somnus runtime import probe exits 0.
 *
 ...
 * its immutable, matching Somnus package; it must never fall through to the

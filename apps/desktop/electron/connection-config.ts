...
/** Which Somnus profile the remote SSH dashboard should actually run as.
...
// Somnus Cloud connection (cloud-auto-discovery Q3/Q6): it carries a
...
function normalizeSshConfig(entry) {
  ...
  // name used by the remote Somnus installation. Preserve an explicit mapping
  // when it is a valid Somnus profile identifier; otherwise fall back to the

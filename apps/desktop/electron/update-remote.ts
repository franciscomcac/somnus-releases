...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/franciscomcac/somnus-releases.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/franciscomcac/somnus-releases'

...
/**
 * Nous — the canonical Somnus desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Somnus's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Somnus desktop identity: GitHub's chrome carrying Nous

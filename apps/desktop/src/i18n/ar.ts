...
export const ar = defineLocale({
  sessionImport: {
    ...
    subtitle: 'انقل محادثة إلى Somnus وتابع من حيث توقفت.',
    action: 'استيراد جلسة',
    ...
    chooseHelp: 'اختر جلسة لقراءة سجلها قبل نقلها إلى Somnus.',
    ...
    you: 'أنت',
    snapshot: 'هذه المحادثة موجودة بالفعل في Somnus. افتح نسختك الحالية للمتابعة.',
    copyNotice: 'ينسخ نص المحادثة دون تغيير الملفات الأصلية. لا يشمل مخرجات الأدوات أو الاستدلال.',
    importing: 'جارٍ الاستيراد…',
    open: 'فتح في Somnus',
    continue: 'المتابعة في Somnus',
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'جار تحميل إعدادات Somnus',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم Somnus البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingHermesDesktop: 'جار تشغيل Somnus...'
    },
    errors: {
      backgroundExited: 'خرجت عملية Somnus الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية Somnus الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Somnus أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateHermes: 'تحديث Somnus',
    ...
    somnusUpdateReadyTitle: 'تحديث Somnus جاهز',
    somnusUpdateReadyMessage: v => `تم تنزيل Somnus ${v}. أعد التشغيل لإكمال التحديث، لن يستغرق ذلك سوى ثوانٍ.`,
    somnusUpdateRestart: 'أعد التشغيل الآن',
    mcp: {
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Somnus.',
    ...
    native: {
      ...
      inputBody: 'ينتظر Somnus ردّك.',
      turnDoneTitle: 'أنهى Somnus',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات Somnus؟',
    ...
    vault: {
      ...
      otpHint: '«مفتاح الإعداد» الذي يعرضه الموقع عند تفعيل المصادقة الثنائية. بحفظه يولّد Somnus الرموز بنفسه.',
      ...
      sources: {
        ...
        notInstalled: name => `غير مكتشف. ثبّت أداة سطر الأوامر ${name} وسجّل الدخول إليها؛ سيكتشفها Somnus تلقائيًا.`,
        disabledDesc: 'مكتشف لكنه معطّل لـ Somnus.',
        lockedDesc: 'مكتشف. سيطلب منك الوكيل فتحه عند الحاجة إلى بيانات دخول، أو افتحه الآن.',
        unlockedDesc: 'مفتوح لهذه الجلسة. يُقفل تلقائيًا بعد 30 دقيقة من الخمول أو عند إغلاق Somnus.',
        statusLocked: 'مقفل',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها Somnus). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون Somnus في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح Somnus سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان Somnus في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح Somnus.',
      ...
      toursDesc:
        'دع Somnus يرشدك في التطبيق مع إبراز كل خطوة. تُعطّل الجولات تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله Somnus — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق Somnus وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج Somnus إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف Somnus التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع Somnus قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل Somnus مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث Somnus نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول Somnus',
      ...
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل Somnus، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فأعد التثبيت من أحدث مثبّت لسطح المكتب.',
      bundleOutOfSyncAction: 'الحصول على المثبّت',
      bundleSwapPending: 'أعد التشغيل لإكمال التحديث',
      bundleSwapPendingDesc:
        'تم تثبيت التطبيق المحدَّث بالفعل — يكفي إعادة تشغيل Somnus لتحميله. لن تتأثر المحادثات أو الإعدادات.',
      bundleSwapPendingAction: 'إعادة تشغيل Somnus',
      updates: 'التحديثات',
      ...
      automaticUpdatesDesc: 'اسمح لـ Somnus بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'تصغير النوافذ أو إغلاق النافذة الرئيسية يخفيها في علبة النظام (شريط القوائم على macOS) مع استمرار Somnus في العمل. استخدم إنهاء Somnus من قائمة العلبة أو Cmd+Q للخروج. معطّل افتراضيًا ويُطبّق على هذا الجهاز فقط.',
      ...
      loading: 'جار تحميل إعدادات Somnus...',
    ...
    hudModifier: {
      ...
      permission:
        'اسمح لـ Somnus في إعدادات النظام ← الخصوصية والأمان ← مراقبة الإدخال، ثم أعد المحاولة. لا تسجّل هذه الإيماءة ضغطات المفاتيح ولا تلتقط الشاشة.',
      unavailable:
        'تعذّر تشغيل مساعد إيماءة HUD أو توقف بشكل غير متوقع. أعد المحاولة أو أعد تشغيل Somnus. يظل اختصار HUD الحالي يعمل داخل Somnus.',
      missingHelper: 'مساعد إيماءة HUD غير موجود في تثبيت Somnus هذا. حدّث Somnus أو أعد تثبيته، ثم أعد المحاولة.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'اضغط مفتاحَي Command معًا من أي تطبيق لالتقاط النافذة الأمامية وإرفاقها بمسودة Somnus الحالية. لا يُرسل أي شيء تلقائيًا. معطّل افتراضيًا ويُطبَّق على جهاز Mac هذا فقط. قد تتضمن النافذة محتوى حساسًا، لذا راجع المرفق قبل الإرسال.',
      ...
      inputPermission:
        'يتيح إذن مراقبة الإدخال لـ Somnus رصد مفتاحَي Command أثناء استخدام تطبيق آخر. اسمح لـ Somnus في إعدادات النظام ← الخصوصية والأمان ← مراقبة الإدخال، ثم عُد إلى هنا وأعد المحاولة.',
      screenPermission:
        'يتيح إذن تسجيل الشاشة لـ Somnus التقاط نافذة التطبيق الأمامية عند استخدام هذا الاختصار. اسمح لـ Somnus في إعدادات النظام ← الخصوصية والأمان ← تسجيل الشاشة، ثم عُد إلى هنا وأعد المحاولة. أعد تشغيل Somnus إذا طلب macOS ذلك.',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح Somnus.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل Somnus بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Somnus تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      ...
      localDesc: 'تشغيل خلفية Somnus خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      ...
      restartingMessage: 'سيعيد Somnus الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · Somnus ${version}` : ''}`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى Somnus. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من Somnus.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Somnus تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل Somnus لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث Somnus لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك Somnus عند الانتهاء.',
    ...
    hermesActiveSessions: (version, count) => `Somnus ${version} لديه ${count} جلسة نشطة`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'كلا الخيارين يربط بوتًا تتحكم به ويحفظ بياناته في هذا التثبيت من Somnus فقط.',
      quickSetup: 'إعداد سريع',
      recommended: 'موصى به',
      quickHelp: 'امسح رمز QR وأكّد في Telegram. سينشئ Somnus البوت ويكتشف معرّف مستخدم Telegram الخاص بك تلقائيًا.',
  ...
  profiles: {
    ...
    defaultDescription: 'يُستخدم عند فتح Somnus وللمحادثات الجديدة. تبقى الجلسات الحالية في ملفاتها الشخصية.',
  ...
  modelAssignment: {
    saveFailed: 'لم يحفظ Somnus تغيير النموذج هذا.',
  ...
  cron: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل Somnus تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها Somnus تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من Somnus أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من Somnus. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم Somnus لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء Somnus...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل Somnus عن شيء...', 'اطلب من Somnus تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ Somnus الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من Somnus فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث Somnus...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل Somnus...',
      done: 'اكتمل التحديث',
    ...
    somnusAutoTitle: 'يتم تحديث Somnus تلقائيًا',
    somnusAutoMessage: 'يحافظ Somnus على تحديث نفسه. تُنزَّل الإصدارات الجديدة في الخلفية وتُثبَّت عند إعادة تشغيل Somnus في المرة القادمة.',
    unsupportedMessage: 'لا يمكن لهذا الإصدار من Somnus تحديث نفسه من داخل التطبيق.',
    connectionRetry: 'تحقق من اتصالك وأعد المحاولة.',
    gitUnusable: 'لم يتمكن Somnus من تشغيل Git على هذا الجهاز، لذا لم يتمكن من التحقق من التحديثات.',
    ...
    availableBody: 'إصدار جديد من Somnus جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة Somnus الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت Somnus من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط Somnus الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Somnus لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث Somnus المهمة في نافذته الخاصة ويعيد فتح Somnus تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح Somnus بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد Somnus الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد Somnus فتح نفسه تلقائيا.',
    errorTitle: 'لم يكتمل التحديث',
    errorBody: 'لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.',
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث Somnus؟',
    blockerBody: 'يحتاج Somnus إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث Somnus',
    foreignBlockerBody:
      'لا يمكن لـ Somnus إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ Somnus إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  guidedGreeting: {
    line: 'أهلا، تفضل بالدخول. أنا Somnus. امنحني دقيقتين لأرتب المكان حولك، ثم نبدأ بشيء تريد إنجازه فعلا.\n\nبداية، بماذا أناديك؟',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج Somnus إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل Somnus',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من Somnus CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ Somnus قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت Somnus بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    ...
    somnusSignInDesc: 'سجّل الدخول أو أنشئ حسابًا مجانيًا في المتصفح. سيتصل Somnus تلقائيًا عند الانتهاء.',
    ...
    somnusAccountNav: 'حساب Somnus',
    somnusAccountTitle: 'حسابك في Somnus',
    somnusAccountDesc: 'تعمل جميع النماذج عبر حسابك في Somnus ويُخصم استخدامها من رصيدك في Somnus. يمكنك شحن الرصيد أو متابعة الاستخدام على موقع Somnus.',
    ...
    somnusAccountUsage30d: (spend, requests) => `${spend} مستخدمة خلال آخر 30 يومًا · ${requests} طلب`,
    somnusAccountTopUp: 'اشحن الرصيد',
    somnusAccountLowCredit: 'نفد رصيدك. اشحن الرصيد لمواصلة استخدام Somnus.',
    somnusAccountSignOut: 'تسجيل الخروج',
    somnusAccountSignOutTitle: 'تسجيل الخروج من Somnus؟',
    somnusAccountSignOutDesc: 'لن يستخدم Somnus حسابك على هذا الكمبيوتر حتى تسجّل الدخول مرة أخرى. تبقى محادثاتك وإعداداتك هنا، ويبقى رصيدك في حسابك.',
    somnusAccountSignedOut: 'تم تسجيل الخروج من Somnus',
    somnusAccountNotSignedIn: 'Somnus غير مسجّل الدخول على هذا الكمبيوتر.',
    somnusAccountExpired: 'انتهت صلاحية تسجيل الدخول. سجّل الدخول مرة أخرى للمتابعة.',
    somnusAccountUnavailable: 'تعذّر تحميل رصيدك الآن.',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل Somnus',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه Somnus إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل Somnus تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل Somnus تلقائياً',
    ...
    authorizeThere: 'صرّح لـ Somnus هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ Somnus هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض Somnus أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل Somnus...',
      askRestart: 'اطلب من Somnus إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث Somnus عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل Somnus في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من Somnus فتح صفحة.',
      finishedRestarting: message => `أنهى Somnus إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على Somnus إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال Somnus يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  interfaceMode: {
    title: 'وضع الواجهة',
    hint: 'يغيّر ما يظهر، وليس ما يستطيع Somnus فعله.',
    sessionNote: 'يحدده الوضع البسيط. التغيير هنا يستمر لهذه الجلسة فقط؛ بدّل إلى المتقدم لجعله خيارك.',
    simple: {
      label: 'بسيط',
      description: 'للتحدث مع Somnus. الشريط الجانبي والدردشة؛ بلا طرفية أو لوحات ملفات أو فروقات.'
    },
    advanced: {
      label: 'متقدم',
  ...
  prompts: {
    ...
    vaultSaveDesc: origin =>
      `وصل Somnus إلى صفحة تسجيل الدخول في ${origin} ولا توجد بيانات دخول محفوظة لها. أدخلها هنا مرة واحدة؛ تُشفَّر على هذا الجهاز وتُملأ في الصفحة مباشرة، ولا يرى النموذج كلمة المرور أبدًا.`,
    ...
    vaultCodeDesc: site =>
      `يطلب ${site} رمزًا لمرة واحدة (رسالة نصية أو بريد إلكتروني أو تطبيق مصادقة). أدخله هنا وسيكتبه Somnus في الصفحة؛ لا يراه النموذج أبدًا.`,
    vaultCodeLabel: 'الرمز',
    vaultCodeFootnote:
      'تلميح: احفظ مفتاح المصادقة مع بيانات الدخول هذه في الإعدادات ← كلمات المرور وتسجيلات الدخول وسيُدخل Somnus الرموز نيابةً عنك.',
    vaultCodeSkip: 'تخطٍ',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'المهارات مجلدات من التعليمات يحمّلها Somnus عندما يقتضي العمل ذلك.'
      },
      messaging: {
        title: 'Somnus بعيدًا عن مكتبك',
        text: 'اربطه بـ Telegram وDiscord وSlack وغيرها — الوكيل نفسه والذاكرة نفسها.'
      },
      artifacts: {
        title: 'كل ما صنعه Somnus',
      ...
      profiles: {
        ...
        text: 'كل واحد منها Somnus مستقل — مفاتيحه وذاكرته وجلساته الخاصة.'
      },
      'composer-mentions': {

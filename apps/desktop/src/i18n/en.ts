...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Somnus to use.',
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'In the Somnus catalog',
    ...
    page: {
      ...
      noMatchBody: 'Nothing here matches. Point Somnus at your own MCP server to add it.',
      ...
      disconnectNoAccount: 'Somnus has no account to disconnect here. Refresh the page and try again.',
      disconnectRefused:
    ...
    dialog: {
      ...
      disconnectBody: 'Somnus stops acting as this account. You can connect again at any time.',
      ...
      rulesSignIn: 'Sign in to change what Somnus may do here.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `What Somnus may do with ${name}`,
      summaryPreviewTitle: (name: string) => `What Somnus could do with ${name} once you connect`,
      ...
      goneBody: 'Somnus cannot call it any more. The row stays until you remove it, so nothing vanishes.',
      remove: 'Remove',
  ...
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Somnus and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Somnus.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Somnus. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Somnus',
    continue: 'Continue in Somnus',
  ...
  boot: {
    ready: 'Somnus is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Somnus settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Somnus backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Somnus…'
    },
    errors: {
      backgroundExited:
        'The service that runs your chats closed unexpectedly. Restart it to keep going — your chats and settings are safe.',
      backgroundExitedDuringStartup: 'Somnus stopped right after it started.',
      backendStopped: 'Somnus stopped working in the background',
      restartHermes: 'Restart Somnus',
      openLogs: 'Open logs',
      desktopBootFailed: "Somnus couldn't start",
      gatewayConnectionLost: 'Somnus lost its connection',
      ...
      gatewaySignInRequired: 'Your remote Somnus signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "Somnus couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "Somnus' background service stopped right after starting.",
      timedOut: "Somnus' background service didn't answer in time.",
      permission: "Somnus couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so Somnus could not start.',
      portInUse: 'Another program is using the network port Somnus needs.',
      installMissing: "Part of Somnus' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "Somnus couldn't start",
      description:
        "Somnus' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Somnus backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Somnus',
    updateReadyTitle: 'Update ready',
    updateReadyMessage: count => `${count} new change${count === 1 ? '' : 's'} available.`,
    updateReadyMessageUnknown: 'A new update is available.',
    seeWhatsNew: "See what's new",
    somnusUpdateReadyTitle: 'Somnus update ready',
    somnusUpdateReadyMessage: v => `Somnus ${v} is downloaded. Restart to finish updating, it only takes a few seconds.`,
    somnusUpdateRestart: 'Restart now',
    mcp: {
    ...
    errors: {
      ...
      storageFailure: "Somnus couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This Somnus no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed:
        "Somnus' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired:
        'Somnus was updated but is still running the old version. Restart it to finish the update.',
      rpcOutOfSync: 'The app and the backend are on different versions. Update both.',
      restartHermesFailed: "Couldn't restart Somnus"
    },
    actions: {
      restartHermes: 'Restart Somnus',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Somnus',
    ...
    native: {
      ...
      inputBody: 'Somnus is waiting for your response.',
      turnDoneTitle: 'Somnus finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Somnus defaults?',
    exportFailed: 'Export failed',
    resetFailed: 'Reset failed',
    nav: {
      providers: 'Providers',
      providerAccounts: 'Somnus account',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Somnus catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Somnus generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Somnus picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Somnus.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Somnus closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Somnus is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Somnus asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Somnus was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Somnus was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Somnus follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Somnus can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Somnus. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Somnus spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Somnus is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Somnus, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallHermes: 'Uninstall Somnus'
    },
    poolLimits: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Somnus runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Somnus only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Somnus',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Somnus checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Minimize windows or close the main window to hide them in the system tray (menu bar on macOS) and keep Somnus running. Use Quit Somnus from the tray menu or Cmd+Q to exit. Off by default; applies only to this device.',
      ...
      loading: 'Loading Somnus configuration...',
    ...
    hudModifier: {
      ...
      permission:
        'Allow Somnus in System Settings → Privacy & Security → Input Monitoring, then retry. This gesture does not record keystrokes or capture your screen.',
      unavailable:
        'The HUD gesture helper could not start or stopped unexpectedly. Retry, or restart Somnus. The existing HUD shortcut still works inside Somnus.',
      missingHelper:
        'This Somnus installation is missing the HUD gesture helper. Update or reinstall Somnus, then retry.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current Somnus draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets Somnus detect both Command keys while another app is active. Allow Somnus in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets Somnus capture the frontmost app window when you use this shortcut. Allow Somnus in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart Somnus if macOS asks.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Somnus.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Somnus gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Somnus Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Somnus Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Somnus runtime managed by this app.',
      kindRemoteDesc: 'A Somnus gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Somnus Cloud account.',
      kindSshDesc: 'A Somnus install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Somnus manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Somnus Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc:
        'Connection settings can only be changed from the Somnus app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a Somnus backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Somnus was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Somnus without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Somnus backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Somnus backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Somnus Cloud',
      cloudDesc: 'Sign in once to Somnus Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Somnus Cloud',
      cloudSignIn: 'Sign in to Somnus Cloud',
      cloudSignedIn: 'Signed in to Somnus Cloud',
      cloudNeedsSignIn: 'Sign in to Somnus Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Somnus Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Somnus Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Somnus Cloud',
      cloudSignedOutMessage: 'Cleared the Somnus Cloud session.',
      ...
      restartingMessage: 'Somnus will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Somnus ${version}` : ''}`,
      ...
      sshDesc:
        'Somnus is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Somnus found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Somnus runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update Somnus on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Somnus. Review the exact configuration below — it comes from the link, not from Somnus.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Somnus starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Somnus runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Somnus at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Somnus can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Somnus browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    plugins: {
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Somnus to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Somnus catalog${sha ? ` at pin ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D is not in the Somnus plugin catalog. Nothing was installed.`,
      deepLinkCatalogUnavailable:
        'Could not load the Somnus plugin catalog. Check your connection and open the link again.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Somnus builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Somnus to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Somnus to generate pets.',
      backgroundHint: 'You can close this — Somnus will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Somnus desktop' },
    ...
    hermesActiveSessions: (version, count) => `Somnus ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "Somnus couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Somnus installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Somnus creates the bot and detects your Telegram user ID automatically.',
  ...
  profiles: {
    ...
    defaultDescription: 'Used when Somnus opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Somnus environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  modelAssignment: {
    saveFailed: 'Somnus did not save that model change.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Somnus will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Somnus backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Somnus. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Somnus backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Somnus...',
    placeholderReconnecting: 'Reconnecting to Somnus…',
    ...
    voiceEngineChained: 'Speech-to-text + Somnus voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Somnus)',
    ...
    attachUrlDesc: 'Somnus will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Somnus to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Somnus…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Somnus…',
    ...
    somnusAutoTitle: 'Somnus updates automatically',
    somnusAutoMessage: 'Somnus keeps itself up to date. New versions download in the background and install the next time you restart Somnus.',
    unsupportedMessage: 'This version of Somnus can’t update itself from inside the app.',
    connectionRetry:
      "Somnus couldn't reach the update server. Check your internet connection and try again. If you use a remote Somnus, make sure it is online.",
    gitUnusable: 'Somnus could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    availableBody: 'A new version of Somnus is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Somnus backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Somnus from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Somnus will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Somnus desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Somnus updater takes over in its own window and reopens Somnus automatically when it’s done. Please don’t reopen Somnus yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Somnus reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Somnus reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Somnus?',
    blockerBody:
      'Somnus needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Somnus',
    foreignBlockerBody:
      'Somnus can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Somnus can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Somnus is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Somnus whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Somnus. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Somnus needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Somnus',
    setupChoiceDesc:
      'Connect this app to a Somnus gateway you already run, or install Somnus locally on this computer.',
    connectExistingTitle: 'Connect to existing Somnus',
    ...
    installLocalTitle: 'Install Somnus locally',
    installLocalDesc: 'Download Somnus, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Somnus and try again.',
    remoteSetupTitle: 'Connect to existing Somnus',
    ...
    settingUpTitle: 'Setting up Somnus',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Somnus is running, the internet connection dropped, or antivirus blocked the installer. Close other Somnus windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
      'This is a one-time setup. The Somnus installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    ...
    somnusSignInDesc: 'Sign in or create a free account in your browser. Somnus connects by itself when you\'re done.',
    ...
    somnusAccountNav: 'Somnus account',
    somnusAccountTitle: 'Your Somnus account',
    somnusAccountDesc: 'Every model runs on your Somnus account and is billed from your Somnus balance. Top up or check your usage on the Somnus website.',
    ...
    somnusAccountUsage30d: (spend, requests) => `${spend} used in the last 30 days · ${requests} requests`,
    somnusAccountTopUp: 'Top up',
    somnusAccountLowCredit: 'You\'re out of credit. Top up to keep using Somnus.',
    somnusAccountSignOut: 'Sign out',
    somnusAccountSignOutTitle: 'Sign out of Somnus?',
    somnusAccountSignOutDesc: 'Somnus stops using your account on this computer until you sign in again. Your chats and settings stay here, and your credit stays in your account.',
    somnusAccountSignedOut: 'Signed out of Somnus',
    somnusAccountNotSignedIn: 'Somnus isn\'t signed in on this computer.',
    somnusAccountExpired: 'Your sign-in expired. Sign in again to keep using Somnus.',
    somnusAccountUnavailable: 'Couldn\'t load your balance right now.',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Somnus',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Somnus at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Somnus connects automatically',
    ...
    authorizeThere: 'Authorize Somnus there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Somnus there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    retiredBody:
      "Your session ended before the sign-in finished. Somnus will start a new one; then sign in again whenever you're ready.",
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `Somnus couldn't finish signing you in because the Nous service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "Somnus couldn't reach the Nous service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This Somnus is already signed in to a Nous account.',
    setupFailed: {
      gateClosed:
        "This version of Somnus can't start without a Nous account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using Somnus without signing in is paused for a moment. Somnus will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so Somnus will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "Somnus couldn't reach the Nous service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      ...
      generic:
        "Somnus couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Somnus v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Somnus Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Somnus will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Somnus is restarting...',
      askRestart: 'Ask Somnus to restart the server',
      lookingRestart: taskId => `Somnus is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Somnus is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Somnus to open a page.',
      finishedRestarting: message => `Somnus finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Somnus could not restart the server.',
      stillWorking:
        'Somnus is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  interfaceMode: {
    ...
    hint: 'Changes what is shown, not what Somnus can do.',
    sessionNote: 'Set by Simple mode. A change here lasts for this session; switch to Advanced to make it yours.',
    simple: {
      label: 'Simple',
      description: 'For talking to Somnus. Sidebar and chat; no terminal, file or diff panes.'
    },
    advanced: {
      label: 'Advanced',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Somnus is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'Somnus hit a problem',
        generic: "Somnus couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Somnus hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so Somnus could not save this conversation. Free some space, then retry.',
        endpoint:
          "Somnus can't reach your custom model server. Check that it is running, then send your message again.",
        gateway:
          'Somnus hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while Somnus was replying. Retry, or copy the details if it keeps happening.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Somnus could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Somnus could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Somnus got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Somnus stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Somnus window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Somnus could not save this conversation. Free some space, then retry.'
        },
        ...
        free_tier_disabled: {
          title: 'Using Somnus without signing in is switched off right now',
        ...
        free_tier_model_not_free: {
          ...
          body: "Somnus uses the free model for now. Sign in with a Nous account for more models, it's free."
        },
        free_tier_route: {
          title: "Somnus couldn't reach the free model on this route",
        ...
        free_tier_refused: {
          title: "Somnus couldn't send that without signing in",
      ...
      errorToastTitle: "Somnus couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenHermesFolder: 'Open Somnus folder',
      errorOpenHermesFolderFailed: 'Could not open the Somnus folder',
    ...
    approval: {
      gatewayDisconnected:
        'Somnus is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Somnus to try again, or raise the limit in Settings → Safety → Approval timeout.',
    ...
    clarify: {
      ...
      gatewayDisconnected: 'Somnus is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'Somnus needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Somnus reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Somnus types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Somnus enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Somnus to use Save Image.',
    restartToSaveImages: 'Restart Somnus to save images',
    ...
    handoff: {
      ...
      timedOut:
        "Somnus couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Somnus loads when the work calls for them.'
      },
      messaging: {
        title: 'Somnus away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Somnus made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Somnus — own keys, own memory, own sessions.'
      },
      'composer-mentions': {

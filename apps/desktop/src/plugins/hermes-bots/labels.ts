...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Somnus". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Somnus" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Somnus (the agent it is)

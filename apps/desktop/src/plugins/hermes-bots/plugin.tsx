/**
 * Somnus Bot Mode — a "one chat per agent" roster for the Somnus desktop.
 *
 * Left pane "Bots": one row per Somnus profile (a bot = an agent profile) with
 ...
 *
 * Right tile "Routines": scheduled tasks (Somnus cron jobs) scoped to the
...
export default {
  ...
  register(ctx: PluginContext) {
    ...
    // A bot's chat before it has spoken: core's splash is Somnus' wordmark and

...
// Connectors are the apps Somnus reads and acts on for the user. Chat channels
// (Discord, Telegram, WhatsApp) are how a user talks to Somnus; those live on
...
// place a single question can answer both: someone here to talk to Somnus
...
export const LAYOUTS: Array<{ description: string; id: string; mode: InterfaceMode; name: string; tree: MiniNode }> = [
  {
    description: 'For talking to Somnus.',
    id: 'sidebar-left',
    mode: 'simple',
    name: 'Basic',

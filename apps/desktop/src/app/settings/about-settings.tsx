...
const RELEASE_NOTES_URL = 'https://github.com/franciscomcac/somnus-releases/releases'
const INSTALLER_URL = 'https://github.com/franciscomcac/somnus-releases/releases/latest'

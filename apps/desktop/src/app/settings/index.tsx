...
const SHOW_NOUS_BILLING = false as boolean
    ...
    () =>
      (
        [
          ...
          // Somnus: Nous Portal billing does not apply; Somnus balance lives in the
          // Somnus account. Kept compiled for upstream parity, never shown.
          ...(SHOW_NOUS_BILLING ? [{

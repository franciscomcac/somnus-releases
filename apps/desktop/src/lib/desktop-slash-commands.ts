...
/** Why a known Somnus command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Somnus profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * Somnus' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Somnus and were never asked for. It is

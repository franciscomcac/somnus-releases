...
//
// When someone is in a hands-free "Hey Somnus" voice chat, the natural way to
...
// phrase (optionally addressed to Somnus), so a real turn that merely contains
 ...
 * to Somnus). Returns false for anything that merely contains "stop" as part of
